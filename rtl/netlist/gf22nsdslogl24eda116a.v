...
//%BEGIN UDBSVT24_ADDABCD_AIY2_1

`celldefine
module UDBSVT24_ADDABCD_AIY2_1 (S, CO, ICO, A, B, C, D, CI);
   output S, CO, ICO;
   input A, B, C, D, CI;
...
//%END UDBSVT24_ADDABCD_AIY2_1

//%BEGIN UDBSVT24_ADDABCD_AIY2_2

`celldefine
module UDBSVT24_ADDABCD_AIY2_2 (S, CO, ICO, A, B, C, D, CI);
   output S, CO, ICO;
   input A, B, C, D, CI;
...
//%END UDBSVT24_ADDABCD_AIY2_2

//%BEGIN UDBSVT24_ADDABCD_FAIY2_1

`celldefine
module UDBSVT24_ADDABCD_FAIY2_1 (S, CO, ICO, A, B, C, D, CI);
   output S, CO, ICO;
   input A, B, C, D, CI;
...
//%END UDBSVT24_ADDABCD_FAIY2_1

//%BEGIN UDBSVT24_ADDABCD_FAIY2_2

`celldefine
module UDBSVT24_ADDABCD_FAIY2_2 (S, CO, ICO, A, B, C, D, CI);
   output S, CO, ICO;
   input A, B, C, D, CI;
...
//%END UDBSVT24_ADDABCD_FAIY2_2

`celldefine
module UDBSVT24_ADDFSB_AIY2_1 (SN, CO, A, B, CI);
  input A, B, CI;
  output SN, CO;
...
//%BEGIN UDBSVT24_ADDF_AIY2_0P5

`celldefine
module UDBSVT24_ADDF_AIY2_0P5 (S, CO, A, B, CI);
   output S, CO;
   input A, B, CI;
...
//%END UDBSVT24_ADDF_AIY2_0P5

//%BEGIN UDBSVT24_ADDF_AIY2_1

`celldefine
module UDBSVT24_ADDF_AIY2_1 (S, CO, A, B, CI);
   output S, CO;
   input A, B, CI;
...
//%END UDBSVT24_ADDF_AIY2_1

//%BEGIN UDBSVT24_ADDF_AIY2_1P5

`celldefine
module UDBSVT24_ADDF_AIY2_1P5 (S, CO, A, B, CI);
   output S, CO;
   input A, B, CI;
...
//%END UDBSVT24_ADDF_AIY2_1P5

//%BEGIN UDBSVT24_ADDF_AIY2_2

`celldefine
module UDBSVT24_ADDF_AIY2_2 (S, CO, A, B, CI);
   output S, CO;
   input A, B, CI;
...
//%END UDBSVT24_ADDF_AIY2_2

//%BEGIN UDBSVT24_ADDH_AI_1

`celldefine
module UDBSVT24_ADDH_AI_1 (S, CO, A, B);
   output S, CO;
   input A, B;
...
//%END UDBSVT24_ADDH_AI_1

//%BEGIN UDBSVT24_ADDH_AI_2

`celldefine
module UDBSVT24_ADDH_AI_2 (S, CO, A, B);
   output S, CO;
   input A, B;
...
//%END UDBSVT24_ADDH_AI_2

//%BEGIN UDBSVT24_BREC_AI_0P5

`celldefine
module UDBSVT24_BREC_AI_0P5 (X1, X2, A0, A1, A2);
   output X1, X2;
   input A0, A1, A2;
...
//%END UDBSVT24_BREC_AI_0P5

//%BEGIN UDBSVT24_BREC_V1AI_1

`celldefine
module UDBSVT24_BREC_V1AI_1 (X1, X2, A0, A1, A2);
   output X1, X2;
   input A0, A1, A2;
...
//%END UDBSVT24_BREC_V1AI_1

//%BEGIN UDBSVT24_BREC_V1AI_2

`celldefine
module UDBSVT24_BREC_V1AI_2 (X1, X2, A0, A1, A2);
   output X1, X2;
   input A0, A1, A2;
...
//%END UDBSVT24_BREC_V1AI_2

//%BEGIN UDBSVT24_BREC_V3AI_1

`celldefine
module UDBSVT24_BREC_V3AI_1 (X1, X2, A0, A1, A2);
   output X1, X2;
   input A0, A1, A2;
...
//%END UDBSVT24_BREC_V3AI_1

//%BEGIN UDBSVT24_BREC_V4AIY2_1

`celldefine
module UDBSVT24_BREC_V4AIY2_1 (X1, X2, A0, A1, A2);
   output X1, X2;
   input A0, A1, A2;
...
//%END UDBSVT24_BREC_V4AIY2_1

//%BEGIN UDBSVT24_BSEL_AI_0P5

`celldefine
module UDBSVT24_BSEL_AI_0P5 (PP, BN1, N, B1, BN0, X2, X1);
   output PP, BN1;
...
//%END UDBSVT24_BSEL_AI_0P5

//%BEGIN UDBSVT24_BSEL_V1AI_1

`celldefine
module UDBSVT24_BSEL_V1AI_1 (PP, BN1, N, B1, BN0, X2, X1);
   output PP, BN1;
   input N, B1, BN0, X2, X1;
...
//%END UDBSVT24_BSEL_V1AI_1

//%BEGIN UDBSVT24_BSEL_V1AI_2

`celldefine
module UDBSVT24_BSEL_V1AI_2 (PP, BN1, N, B1, BN0, X2, X1);
   output PP, BN1;
   input N, B1, BN0, X2, X1;
...
//%END UDBSVT24_BSEL_V1AI_2

//%BEGIN UDBSVT24_BSEL_V2AI_0P5

`celldefine
module UDBSVT24_BSEL_V2AI_0P5 (PP, BN1, N, B1, BN0, X2, X1);
   output PP, BN1;
   input N, B1, BN0, X2, X1;
...
//%END UDBSVT24_BSEL_V2AI_0P5

//%BEGIN UDBSVT24_BSEL_V3AI_1

`celldefine
module UDBSVT24_BSEL_V3AI_1 (PP, BN1, N, B1, BN0, X2, X1);
   output PP, BN1;
   input N, B1, BN0, X2, X1;
...
//%END UDBSVT24_BSEL_V3AI_1

//%BEGIN UDBSVT24_BUF_AI_10

`celldefine
module UDBSVT24_BUF_AI_10 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_10

//%BEGIN UDBSVT24_BUF_AI_12

`celldefine
module UDBSVT24_BUF_AI_12 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_12

//%BEGIN UDBSVT24_BUF_AI_14

`celldefine
module UDBSVT24_BUF_AI_14 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_14

//%BEGIN UDBSVT24_BUF_AI_16

`celldefine
module UDBSVT24_BUF_AI_16 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_16

//%BEGIN UDBSVT24_BUF_AI_2

`celldefine
module UDBSVT24_BUF_AI_2 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_2

//%BEGIN UDBSVT24_BUF_AI_20

`celldefine
module UDBSVT24_BUF_AI_20 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_20

//%BEGIN UDBSVT24_BUF_AI_24

`celldefine
module UDBSVT24_BUF_AI_24 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_24

//%BEGIN UDBSVT24_BUF_AI_28

`celldefine
module UDBSVT24_BUF_AI_28 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_28

//%BEGIN UDBSVT24_BUF_AI_3

`celldefine
module UDBSVT24_BUF_AI_3 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_3

//%BEGIN UDBSVT24_BUF_AI_32

`celldefine
module UDBSVT24_BUF_AI_32 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_32

//%BEGIN UDBSVT24_BUF_AI_4

`celldefine
module UDBSVT24_BUF_AI_4 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_4

//%BEGIN UDBSVT24_BUF_AI_5

`celldefine
module UDBSVT24_BUF_AI_5 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_5

//%BEGIN UDBSVT24_BUF_AI_6

`celldefine
module UDBSVT24_BUF_AI_6 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_6

//%BEGIN UDBSVT24_BUF_AI_7

`celldefine
module UDBSVT24_BUF_AI_7 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_7

//%BEGIN UDBSVT24_BUF_AI_8

`celldefine
module UDBSVT24_BUF_AI_8 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_AI_8

//%BEGIN UDBSVT24_BUF_LPAI_28

`celldefine
module UDBSVT24_BUF_LPAI_28 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_LPAI_28

//%BEGIN UDBSVT24_BUF_LPAI_32

`celldefine
module UDBSVT24_BUF_LPAI_32 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_LPAI_32

//%BEGIN UDBSVT24_BUF_LPAI_7

`celldefine
module UDBSVT24_BUF_LPAI_7 (X, A);
   output X;
   input A;
...
//%END UDBSVT24_BUF_LPAI_7

//%BEGIN UDBSVT24_EN2_AIY2_1

`celldefine
module UDBSVT24_EN2_AIY2_1 (X, A1, A2);
   output X;
   input A1, A2;
...
//%END UDBSVT24_EN2_AIY2_1

//%BEGIN UDBSVT24_EO2_AIY2_1

`celldefine
module UDBSVT24_EO2_AIY2_1 (X, A1, A2);
   output X;
   input A1, A2;
