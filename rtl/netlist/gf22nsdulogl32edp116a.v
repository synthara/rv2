...
//%BEGIN UDPUHT32_BUF_PNR_1

`celldefine
module UDPUHT32_BUF_PNR_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_BUF_PNR_1

//%BEGIN UDPUHT32_BUF_PNR_16

`celldefine
module UDPUHT32_BUF_PNR_16 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_BUF_PNR_16

//%BEGIN UDPUHT32_BUF_PNR_2

`celldefine
module UDPUHT32_BUF_PNR_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_BUF_PNR_2

//%BEGIN UDPUHT32_BUF_PNR_4

`celldefine
module UDPUHT32_BUF_PNR_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_BUF_PNR_4

//%BEGIN UDPUHT32_BUF_PNR_8

`celldefine
module UDPUHT32_BUF_PNR_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_BUF_PNR_8

`celldefine
module UDPUHT32_CLAMPB_DY7_2 (X, A);
  input A;
  output X;
...
`celldefine
module UDPUHT32_CLAMPB_SY7_2 (X, A);
  input A;
  output X;
...
//%BEGIN UDPUHT32_FSB2DPQ_PV2NR_1

`celldefine
module UDPUHT32_FSB2DPQ_PV2NR_1 (Q, CK, D, SI, SE, B1, B2);
...
//%END UDPUHT32_FSB2DPQ_PV2NR_1

//%BEGIN UDPUHT32_FSB2DPQ_PV2NR_2

`celldefine
module UDPUHT32_FSB2DPQ_PV2NR_2 (Q, CK, D, SI, SE, B1, B2);
  input CK, D, SI, SE, B1, B2;
  output Q;
  reg viol_0;
    wire xcr_9;
...
//%END UDPUHT32_FSB2DPQ_PV2NR_2

//%BEGIN UDPUHT32_FSB2DPQ_PV2NR_4

`celldefine
module UDPUHT32_FSB2DPQ_PV2NR_4 (Q, CK, D, SI, SE, B1, B2);
  input CK, D, SI, SE, B1, B2;
  output Q;
  reg viol_0;
    wire xcr_9;
...
//%END UDPUHT32_FSB2DPQ_PV2NR_4

//%BEGIN UDPUHT32_FSB2DPRBQ_PV2NR_1

`celldefine
module UDPUHT32_FSB2DPRBQ_PV2NR_1 (Q, CK, D, SI, SE, RD, B1, B2);
...
//%END UDPUHT32_FSB2DPRBQ_PV2NR_1

//%BEGIN UDPUHT32_FSB2DPRBQ_PV2NR_4

`celldefine
module UDPUHT32_FSB2DPRBQ_PV2NR_4 (Q, CK, D, SI, SE, RD, B1, B2);
  input CK, D, SI, SE, RD, B1, B2;
  output Q;
  reg viol_0;
    wire xcr_11;
...
//%END UDPUHT32_FSB2DPRBQ_PV2NR_4

//%BEGIN UDPUHT32_FSB2DPSBQ_PV2NR_1

`celldefine
module UDPUHT32_FSB2DPSBQ_PV2NR_1 (Q, CK, D, SI, SE, SD, B1, B2);
...
//%END UDPUHT32_FSB2DPSBQ_PV2NR_1

//%BEGIN UDPUHT32_FSB2DPSBQ_PV2NR_2

`celldefine
module UDPUHT32_FSB2DPSBQ_PV2NR_2 (Q, CK, D, SI, SE, SD, B1, B2);
  input CK, D, SI, SE, SD, B1, B2;
  output Q;
  reg viol_0;
    wire xcr_11;
...
//%END UDPUHT32_FSB2DPSBQ_PV2NR_2

//%BEGIN UDPUHT32_FSB2DPSBQ_PV2NR_4

`celldefine
module UDPUHT32_FSB2DPSBQ_PV2NR_4 (Q, CK, D, SI, SE, SD, B1, B2);
  input CK, D, SI, SE, SD, B1, B2;
  output Q;
  reg viol_0;
    wire xcr_11;
...
//%END UDPUHT32_FSB2DPSBQ_PV2NR_4

//%BEGIN UDPUHT32_FSRBDPQ_PV2NR_1
`celldefine
module UDPUHT32_FSRBDPQ_PV2NR_1 (Q, CK, D, SI, SE, SR);
  input CK, D, SI, SE, SR;
  output Q;
  reg viol_0;
    wire viol_x;
...
`endcelldefine
//%END UDPUHT32_FSRBDPQ_PV2NR_1

//%BEGIN UDPUHT32_FSRBDPQ_PV2NR_2
`celldefine
module UDPUHT32_FSRBDPQ_PV2NR_2 (Q, CK, D, SI, SE, SR);
  input CK, D, SI, SE, SR;
  output Q;
  reg viol_0;
    wire viol_x;
...
`endcelldefine
//%END UDPUHT32_FSRBDPQ_PV2NR_2

//%BEGIN UDPUHT32_FSRBDPQ_PV2NR_4
`celldefine
module UDPUHT32_FSRBDPQ_PV2NR_4 (Q, CK, D, SI, SE, SR);
  input CK, D, SI, SE, SR;
  output Q;
  reg viol_0;
    wire viol_x;
...
`endcelldefine
//%END UDPUHT32_FSRBDPQ_PV2NR_4

//%BEGIN UDPUHT32_FSRBDPRBQ_PV2NR_1
`celldefine
module UDPUHT32_FSRBDPRBQ_PV2NR_1 (Q, CK, D, SI, SE, RD, SR);
...
`endcelldefine
//%END UDPUHT32_FSRBDPRBQ_PV2NR_1

//%BEGIN UDPUHT32_FSRBDPRBQ_PV2NR_2
`celldefine
module UDPUHT32_FSRBDPRBQ_PV2NR_2 (Q, CK, D, SI, SE, RD, SR);
  input CK, D, SI, SE, RD, SR;
  output Q;
  reg viol_0;
    wire viol_x;
...
`endcelldefine
//%END UDPUHT32_FSRBDPRBQ_PV2NR_2

//%BEGIN UDPUHT32_FSRBDPRBQ_PV2NR_4
`celldefine
module UDPUHT32_FSRBDPRBQ_PV2NR_4 (Q, CK, D, SI, SE, RD, SR);
  input CK, D, SI, SE, RD, SR;
  output Q;
  reg viol_0;
    wire viol_x;
...
`endcelldefine
//%END UDPUHT32_FSRBDPRBQ_PV2NR_4

//%BEGIN UDPUHT32_FSRBDPSBQ_PV2NR_1
`celldefine
module UDPUHT32_FSRBDPSBQ_PV2NR_1 (Q, CK, D, SI, SE, SD, SR);
...
`endcelldefine
//%END UDPUHT32_FSRBDPSBQ_PV2NR_1

//%BEGIN UDPUHT32_FSRBDPSBQ_PV2NR_2
`celldefine
module UDPUHT32_FSRBDPSBQ_PV2NR_2 (Q, CK, D, SI, SE, SD, SR);
  input CK, D, SI, SE, SD, SR;
  output Q;
  reg viol_0;
    wire viol_x;
...
`endcelldefine
//%END UDPUHT32_FSRBDPSBQ_PV2NR_2

//%BEGIN UDPUHT32_FSRBDPSBQ_PV2NR_4
`celldefine
module UDPUHT32_FSRBDPSBQ_PV2NR_4 (Q, CK, D, SI, SE, SD, SR);
  input CK, D, SI, SE, SD, SR;
  output Q;
  reg viol_0;
    wire viol_x;
...
`endcelldefine
//%END UDPUHT32_FSRBDPSBQ_PV2NR_4

//%BEGIN UDPUHT32_INV_PNR_1

`celldefine
module UDPUHT32_INV_PNR_1 (X, A);
   output X;
   input A;
...
`endcelldefine
//
//%END UDPUHT32_INV_PNR_1

//%BEGIN UDPUHT32_INV_PNR_16

`celldefine
module UDPUHT32_INV_PNR_16 (X, A);
   output X;
   input A;
...
`endcelldefine
//
//%END UDPUHT32_INV_PNR_16

//%BEGIN UDPUHT32_INV_PNR_2

`celldefine
module UDPUHT32_INV_PNR_2 (X, A);
   output X;
   input A;
...
`endcelldefine
//
//%END UDPUHT32_INV_PNR_2

//%BEGIN UDPUHT32_INV_PNR_4

`celldefine
module UDPUHT32_INV_PNR_4 (X, A);
   output X;
   input A;
...
`endcelldefine
//
//%END UDPUHT32_INV_PNR_4

//%BEGIN UDPUHT32_INV_PNR_8

`celldefine
module UDPUHT32_INV_PNR_8 (X, A);
   output X;
   input A;
...
`endcelldefine
//
//%END UDPUHT32_INV_PNR_8

//%BEGIN UDPUHT32_ISOS0CL1_1

`celldefine
module UDPUHT32_ISOS0CL1_1 (X, A, EN0);
   output X;
   input A, EN0;
...
//%END UDPUHT32_ISOS0CL1_1

//%BEGIN UDPUHT32_ISOS0CL1_2

`celldefine
module UDPUHT32_ISOS0CL1_2 (X, A, EN0);
   output X;
   input A, EN0;
...
//%END UDPUHT32_ISOS0CL1_2

//%BEGIN UDPUHT32_ISOS0CL1_4

`celldefine
module UDPUHT32_ISOS0CL1_4 (X, A, EN0);
   output X;
   input A, EN0;
...
//%END UDPUHT32_ISOS0CL1_4

//%BEGIN UDPUHT32_ISOS0CL1_PNR_1

`celldefine
module UDPUHT32_ISOS0CL1_PNR_1 (X, A, EN0);
   output X;
   input A, EN0;
...
//%END UDPUHT32_ISOS0CL1_PNR_1

//%BEGIN UDPUHT32_ISOS0CL1_PNR_2

`celldefine
module UDPUHT32_ISOS0CL1_PNR_2 (X, A, EN0);
   output X;
   input A, EN0;
...
//%END UDPUHT32_ISOS0CL1_PNR_2

//%BEGIN UDPUHT32_ISOS0CL1_PNR_4

`celldefine
module UDPUHT32_ISOS0CL1_PNR_4 (X, A, EN0);
   output X;
   input A, EN0;
...
//%END UDPUHT32_ISOS0CL1_PNR_4

//%BEGIN UDPUHT32_ISOS1CL0_1

`celldefine
module UDPUHT32_ISOS1CL0_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_ISOS1CL0_1

//%BEGIN UDPUHT32_ISOS1CL0_2

`celldefine
module UDPUHT32_ISOS1CL0_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_ISOS1CL0_2

//%BEGIN UDPUHT32_ISOS1CL0_4

`celldefine
module UDPUHT32_ISOS1CL0_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_ISOS1CL0_4

//%BEGIN UDPUHT32_ISOS1CL0_PNR_1

`celldefine
module UDPUHT32_ISOS1CL0_PNR_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_ISOS1CL0_PNR_1

//%BEGIN UDPUHT32_ISOS1CL0_PNR_2

`celldefine
module UDPUHT32_ISOS1CL0_PNR_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_ISOS1CL0_PNR_2

//%BEGIN UDPUHT32_ISOS1CL0_PNR_4

`celldefine
module UDPUHT32_ISOS1CL0_PNR_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_ISOS1CL0_PNR_4

//%BEGIN UDPUHT32_LVLDBUFE0M2_2
`celldefine
module UDPUHT32_LVLDBUFE0M2_2 (X0, X1, A0, A1, EN);
  input A0, A1, EN;
  output X0, X1;
  wire int_0, int_1;
...
`endcelldefine
//%END UDPUHT32_LVLDBUFE0M2_2

//%BEGIN UDPUHT32_LVLDBUFE0M2_4
`celldefine
module UDPUHT32_LVLDBUFE0M2_4 (X0, X1, A0, A1, EN);
  input A0, A1, EN;
  output X0, X1;
  wire int_0, int_1;
...
`endcelldefine
//%END UDPUHT32_LVLDBUFE0M2_4

//%BEGIN UDPUHT32_LVLDBUFE0M2_8
`celldefine
module UDPUHT32_LVLDBUFE0M2_8 (X0, X1, A0, A1, EN);
  input A0, A1, EN;
  output X0, X1;
  wire int_0, int_1;
...
`endcelldefine
//%END UDPUHT32_LVLDBUFE0M2_8

//%BEGIN UDPUHT32_LVLDBUFE0M4_2
`celldefine
module UDPUHT32_LVLDBUFE0M4_2 (X0, X1, X2, X3, A0, A1, A2, A3, EN);
...
`endcelldefine
//%END UDPUHT32_LVLDBUFE0M4_2

//%BEGIN UDPUHT32_LVLDBUFE0M4_4
`celldefine
module UDPUHT32_LVLDBUFE0M4_4 (X0, X1, X2, X3, A0, A1, A2, A3, EN);
  input A0, A1, A2, A3, EN;
  output X0, X1, X2, X3;
  wire int_0, int_1, int_2, int_3;
...
`endcelldefine
//%END UDPUHT32_LVLDBUFE0M4_4

//%BEGIN UDPUHT32_LVLDBUFE0M4_8
`celldefine
module UDPUHT32_LVLDBUFE0M4_8 (X0, X1, X2, X3, A0, A1, A2, A3, EN);
  input A0, A1, A2, A3, EN;
  output X0, X1, X2, X3;
  wire int_0, int_1, int_2, int_3;
...
`endcelldefine
//%END UDPUHT32_LVLDBUFE0M4_8

//%BEGIN UDPUHT32_LVLDBUFE0_1

`celldefine
module UDPUHT32_LVLDBUFE0_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_1

//%BEGIN UDPUHT32_LVLDBUFE0_2

`celldefine
module UDPUHT32_LVLDBUFE0_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_2

//%BEGIN UDPUHT32_LVLDBUFE0_4

`celldefine
module UDPUHT32_LVLDBUFE0_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_4

//%BEGIN UDPUHT32_LVLDBUFE0_8

`celldefine
module UDPUHT32_LVLDBUFE0_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_8

//%BEGIN UDPUHT32_LVLDBUFE0_DPNR_1

`celldefine
module UDPUHT32_LVLDBUFE0_DPNR_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_DPNR_1

//%BEGIN UDPUHT32_LVLDBUFE0_DPNR_2

`celldefine
module UDPUHT32_LVLDBUFE0_DPNR_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_DPNR_2

//%BEGIN UDPUHT32_LVLDBUFE0_DPNR_4

`celldefine
module UDPUHT32_LVLDBUFE0_DPNR_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_DPNR_4

//%BEGIN UDPUHT32_LVLDBUFE0_DPNR_8

`celldefine
module UDPUHT32_LVLDBUFE0_DPNR_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_DPNR_8

//%BEGIN UDPUHT32_LVLDBUFE0_D_1

`celldefine
module UDPUHT32_LVLDBUFE0_D_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_D_1

//%BEGIN UDPUHT32_LVLDBUFE0_D_2

`celldefine
module UDPUHT32_LVLDBUFE0_D_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_D_2

//%BEGIN UDPUHT32_LVLDBUFE0_D_4

`celldefine
module UDPUHT32_LVLDBUFE0_D_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_D_4

//%BEGIN UDPUHT32_LVLDBUFE0_D_8

`celldefine
module UDPUHT32_LVLDBUFE0_D_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_D_8

//%BEGIN UDPUHT32_LVLDBUFE0_O_1

`celldefine
module UDPUHT32_LVLDBUFE0_O_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_O_1

//%BEGIN UDPUHT32_LVLDBUFE0_O_2

`celldefine
module UDPUHT32_LVLDBUFE0_O_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_O_2

//%BEGIN UDPUHT32_LVLDBUFE0_O_4

`celldefine
module UDPUHT32_LVLDBUFE0_O_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_O_4

//%BEGIN UDPUHT32_LVLDBUFE0_O_8

`celldefine
module UDPUHT32_LVLDBUFE0_O_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_O_8

//%BEGIN UDPUHT32_LVLDBUFE0_PNR_1

`celldefine
module UDPUHT32_LVLDBUFE0_PNR_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PNR_1

//%BEGIN UDPUHT32_LVLDBUFE0_PNR_2

`celldefine
module UDPUHT32_LVLDBUFE0_PNR_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PNR_2

//%BEGIN UDPUHT32_LVLDBUFE0_PNR_4

`celldefine
module UDPUHT32_LVLDBUFE0_PNR_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PNR_4

//%BEGIN UDPUHT32_LVLDBUFE0_PNR_8

`celldefine
module UDPUHT32_LVLDBUFE0_PNR_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PNR_8

//%BEGIN UDPUHT32_LVLDBUFE0_PONR_1

`celldefine
module UDPUHT32_LVLDBUFE0_PONR_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PONR_1

//%BEGIN UDPUHT32_LVLDBUFE0_PONR_2

`celldefine
module UDPUHT32_LVLDBUFE0_PONR_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PONR_2

//%BEGIN UDPUHT32_LVLDBUFE0_PONR_4

`celldefine
module UDPUHT32_LVLDBUFE0_PONR_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PONR_4

//%BEGIN UDPUHT32_LVLDBUFE0_PONR_8

`celldefine
module UDPUHT32_LVLDBUFE0_PONR_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDBUFE0_PONR_8

//%BEGIN UDPUHT32_LVLDBUF_1

`celldefine
module UDPUHT32_LVLDBUF_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_1

//%BEGIN UDPUHT32_LVLDBUF_2

`celldefine
module UDPUHT32_LVLDBUF_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_2

//%BEGIN UDPUHT32_LVLDBUF_4

`celldefine
module UDPUHT32_LVLDBUF_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_4

//%BEGIN UDPUHT32_LVLDBUF_8

`celldefine
module UDPUHT32_LVLDBUF_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_8

//%BEGIN UDPUHT32_LVLDBUF_DPNR_1

`celldefine
module UDPUHT32_LVLDBUF_DPNR_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_DPNR_1

//%BEGIN UDPUHT32_LVLDBUF_DPNR_2

`celldefine
module UDPUHT32_LVLDBUF_DPNR_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_DPNR_2

//%BEGIN UDPUHT32_LVLDBUF_DPNR_4

`celldefine
module UDPUHT32_LVLDBUF_DPNR_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_DPNR_4

//%BEGIN UDPUHT32_LVLDBUF_DPNR_8

`celldefine
module UDPUHT32_LVLDBUF_DPNR_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_DPNR_8

//%BEGIN UDPUHT32_LVLDBUF_D_1

`celldefine
module UDPUHT32_LVLDBUF_D_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_D_1

//%BEGIN UDPUHT32_LVLDBUF_D_2

`celldefine
module UDPUHT32_LVLDBUF_D_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_D_2

//%BEGIN UDPUHT32_LVLDBUF_D_4

`celldefine
module UDPUHT32_LVLDBUF_D_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_D_4

//%BEGIN UDPUHT32_LVLDBUF_D_8

`celldefine
module UDPUHT32_LVLDBUF_D_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_D_8

//%BEGIN UDPUHT32_LVLDBUF_O_1

`celldefine
module UDPUHT32_LVLDBUF_O_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_O_1

//%BEGIN UDPUHT32_LVLDBUF_O_2

`celldefine
module UDPUHT32_LVLDBUF_O_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_O_2

//%BEGIN UDPUHT32_LVLDBUF_O_4

`celldefine
module UDPUHT32_LVLDBUF_O_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_O_4

//%BEGIN UDPUHT32_LVLDBUF_O_8

`celldefine
module UDPUHT32_LVLDBUF_O_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_O_8

//%BEGIN UDPUHT32_LVLDBUF_PNR_1

`celldefine
module UDPUHT32_LVLDBUF_PNR_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PNR_1

//%BEGIN UDPUHT32_LVLDBUF_PNR_2

`celldefine
module UDPUHT32_LVLDBUF_PNR_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PNR_2

//%BEGIN UDPUHT32_LVLDBUF_PNR_4

`celldefine
module UDPUHT32_LVLDBUF_PNR_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PNR_4

//%BEGIN UDPUHT32_LVLDBUF_PNR_8

`celldefine
module UDPUHT32_LVLDBUF_PNR_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PNR_8

//%BEGIN UDPUHT32_LVLDBUF_PONR_1

`celldefine
module UDPUHT32_LVLDBUF_PONR_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PONR_1

//%BEGIN UDPUHT32_LVLDBUF_PONR_2

`celldefine
module UDPUHT32_LVLDBUF_PONR_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PONR_2

//%BEGIN UDPUHT32_LVLDBUF_PONR_4

`celldefine
module UDPUHT32_LVLDBUF_PONR_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PONR_4

//%BEGIN UDPUHT32_LVLDBUF_PONR_8

`celldefine
module UDPUHT32_LVLDBUF_PONR_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDBUF_PONR_8

//%BEGIN UDPUHT32_LVLDINVE1_1

`celldefine
module UDPUHT32_LVLDINVE1_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_1


//%BEGIN UDPUHT32_LVLDINVE1_2

`celldefine
module UDPUHT32_LVLDINVE1_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_2


//%BEGIN UDPUHT32_LVLDINVE1_4

`celldefine
module UDPUHT32_LVLDINVE1_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_4


//%BEGIN UDPUHT32_LVLDINVE1_8

`celldefine
module UDPUHT32_LVLDINVE1_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_8


//%BEGIN UDPUHT32_LVLDINVE1_DPNR_1

`celldefine
module UDPUHT32_LVLDINVE1_DPNR_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_DPNR_1


//%BEGIN UDPUHT32_LVLDINVE1_DPNR_2

`celldefine
module UDPUHT32_LVLDINVE1_DPNR_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_DPNR_2


//%BEGIN UDPUHT32_LVLDINVE1_DPNR_4

`celldefine
module UDPUHT32_LVLDINVE1_DPNR_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_DPNR_4


//%BEGIN UDPUHT32_LVLDINVE1_DPNR_8

`celldefine
module UDPUHT32_LVLDINVE1_DPNR_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_DPNR_8


//%BEGIN UDPUHT32_LVLDINVE1_D_1

`celldefine
module UDPUHT32_LVLDINVE1_D_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_D_1


//%BEGIN UDPUHT32_LVLDINVE1_D_2

`celldefine
module UDPUHT32_LVLDINVE1_D_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_D_2


//%BEGIN UDPUHT32_LVLDINVE1_D_4

`celldefine
module UDPUHT32_LVLDINVE1_D_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_D_4


//%BEGIN UDPUHT32_LVLDINVE1_D_8

`celldefine
module UDPUHT32_LVLDINVE1_D_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_D_8


//%BEGIN UDPUHT32_LVLDINVE1_O_1

`celldefine
module UDPUHT32_LVLDINVE1_O_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_O_1


//%BEGIN UDPUHT32_LVLDINVE1_O_2

`celldefine
module UDPUHT32_LVLDINVE1_O_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_O_2


//%BEGIN UDPUHT32_LVLDINVE1_O_4

`celldefine
module UDPUHT32_LVLDINVE1_O_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_O_4


//%BEGIN UDPUHT32_LVLDINVE1_O_8

`celldefine
module UDPUHT32_LVLDINVE1_O_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_O_8


//%BEGIN UDPUHT32_LVLDINVE1_PNR_1

`celldefine
module UDPUHT32_LVLDINVE1_PNR_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PNR_1


//%BEGIN UDPUHT32_LVLDINVE1_PNR_2

`celldefine
module UDPUHT32_LVLDINVE1_PNR_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PNR_2


//%BEGIN UDPUHT32_LVLDINVE1_PNR_4

`celldefine
module UDPUHT32_LVLDINVE1_PNR_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PNR_4


//%BEGIN UDPUHT32_LVLDINVE1_PNR_8

`celldefine
module UDPUHT32_LVLDINVE1_PNR_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PNR_8


//%BEGIN UDPUHT32_LVLDINVE1_PONR_1

`celldefine
module UDPUHT32_LVLDINVE1_PONR_1 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PONR_1


//%BEGIN UDPUHT32_LVLDINVE1_PONR_2

`celldefine
module UDPUHT32_LVLDINVE1_PONR_2 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PONR_2


//%BEGIN UDPUHT32_LVLDINVE1_PONR_4

`celldefine
module UDPUHT32_LVLDINVE1_PONR_4 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PONR_4


//%BEGIN UDPUHT32_LVLDINVE1_PONR_8

`celldefine
module UDPUHT32_LVLDINVE1_PONR_8 (X, A, EN);
   output X;
   input A, EN;
...
//%END UDPUHT32_LVLDINVE1_PONR_8


//%BEGIN UDPUHT32_LVLDINV_1

`celldefine
module UDPUHT32_LVLDINV_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_1


//%BEGIN UDPUHT32_LVLDINV_2

`celldefine
module UDPUHT32_LVLDINV_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_2


//%BEGIN UDPUHT32_LVLDINV_4

`celldefine
module UDPUHT32_LVLDINV_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_4


//%BEGIN UDPUHT32_LVLDINV_8

`celldefine
module UDPUHT32_LVLDINV_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_8


//%BEGIN UDPUHT32_LVLDINV_DPNR_1

`celldefine
module UDPUHT32_LVLDINV_DPNR_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_DPNR_1


//%BEGIN UDPUHT32_LVLDINV_DPNR_2

`celldefine
module UDPUHT32_LVLDINV_DPNR_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_DPNR_2


//%BEGIN UDPUHT32_LVLDINV_DPNR_4

`celldefine
module UDPUHT32_LVLDINV_DPNR_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_DPNR_4


//%BEGIN UDPUHT32_LVLDINV_DPNR_8

`celldefine
module UDPUHT32_LVLDINV_DPNR_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_DPNR_8


//%BEGIN UDPUHT32_LVLDINV_D_1

`celldefine
module UDPUHT32_LVLDINV_D_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_D_1


//%BEGIN UDPUHT32_LVLDINV_D_2

`celldefine
module UDPUHT32_LVLDINV_D_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_D_2


//%BEGIN UDPUHT32_LVLDINV_D_4

`celldefine
module UDPUHT32_LVLDINV_D_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_D_4


//%BEGIN UDPUHT32_LVLDINV_D_8

`celldefine
module UDPUHT32_LVLDINV_D_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_D_8


//%BEGIN UDPUHT32_LVLDINV_O_1

`celldefine
module UDPUHT32_LVLDINV_O_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_O_1


//%BEGIN UDPUHT32_LVLDINV_O_2

`celldefine
module UDPUHT32_LVLDINV_O_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_O_2


//%BEGIN UDPUHT32_LVLDINV_O_4

`celldefine
module UDPUHT32_LVLDINV_O_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_O_4


//%BEGIN UDPUHT32_LVLDINV_O_8

`celldefine
module UDPUHT32_LVLDINV_O_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_O_8


//%BEGIN UDPUHT32_LVLDINV_PNR_1

`celldefine
module UDPUHT32_LVLDINV_PNR_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PNR_1


//%BEGIN UDPUHT32_LVLDINV_PNR_2

`celldefine
module UDPUHT32_LVLDINV_PNR_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PNR_2


//%BEGIN UDPUHT32_LVLDINV_PNR_4

`celldefine
module UDPUHT32_LVLDINV_PNR_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PNR_4


//%BEGIN UDPUHT32_LVLDINV_PNR_8

`celldefine
module UDPUHT32_LVLDINV_PNR_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PNR_8


//%BEGIN UDPUHT32_LVLDINV_PONR_1

`celldefine
module UDPUHT32_LVLDINV_PONR_1 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PONR_1


//%BEGIN UDPUHT32_LVLDINV_PONR_2

`celldefine
module UDPUHT32_LVLDINV_PONR_2 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PONR_2


//%BEGIN UDPUHT32_LVLDINV_PONR_4

`celldefine
module UDPUHT32_LVLDINV_PONR_4 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PONR_4


//%BEGIN UDPUHT32_LVLDINV_PONR_8

`celldefine
module UDPUHT32_LVLDINV_PONR_8 (X, A);
   output X;
   input A;
...
//%END UDPUHT32_LVLDINV_PONR_8


//%BEGIN UDPUHT32_PGATBDRV_CONRY2_10

`celldefine
module UDPUHT32_PGATBDRV_CONRY2_10 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBDRV_CONRY2_10

//%BEGIN UDPUHT32_PGATBDRV_CONR_6

`celldefine
module UDPUHT32_PGATBDRV_CONR_6 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBDRV_CONR_6

//%BEGIN UDPUHT32_PGATBDRV_ONRY2_10

`celldefine
module UDPUHT32_PGATBDRV_ONRY2_10 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBDRV_ONRY2_10

//%BEGIN UDPUHT32_PGATBDRV_ONR_6

`celldefine
module UDPUHT32_PGATBDRV_ONR_6 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBDRV_ONR_6

//%BEGIN UDPUHT32_PGATBDRV_ORNRY2_10

`celldefine
module UDPUHT32_PGATBDRV_ORNRY2_10 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBDRV_ORNRY2_10

//%BEGIN UDPUHT32_PGATBDRV_ORNR_10

`celldefine
module UDPUHT32_PGATBDRV_ORNR_10 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBDRV_ORNR_10

//%BEGIN UDPUHT32_PGATBFILL_CONRY2_10

`celldefine
module UDPUHT32_PGATBFILL_CONRY2_10 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBFILL_CONRY2_10

//%BEGIN UDPUHT32_PGATBFILL_CONR_6

`celldefine
module UDPUHT32_PGATBFILL_CONR_6 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBFILL_CONR_6

//%BEGIN UDPUHT32_PGATBFILL_ONRY2_10

`celldefine
module UDPUHT32_PGATBFILL_ONRY2_10 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBFILL_ONRY2_10

//%BEGIN UDPUHT32_PGATBFILL_ONR_6

`celldefine
module UDPUHT32_PGATBFILL_ONR_6 (ENX, EN);
   output ENX;
   input EN;
...
//%END UDPUHT32_PGATBFILL_ONR_6

//%BEGIN UDPUHT32_PGATDRV_CONRY2_10

`celldefine
module UDPUHT32_PGATDRV_CONRY2_10 (ENXB);
   input ENXB;

endmodule
`endcelldefine

//%END UDPUHT32_PGATDRV_CONRY2_10

//%BEGIN UDPUHT32_PGATDRV_CONR_6

`celldefine
module UDPUHT32_PGATDRV_CONR_6 (ENXB);
   input ENXB;

endmodule
`endcelldefine

//%END UDPUHT32_PGATDRV_CONR_6

//%BEGIN UDPUHT32_PGATDRV_ONRY2_10

`celldefine
module UDPUHT32_PGATDRV_ONRY2_10 (ENXB);
   input ENXB;

endmodule
`endcelldefine

//%END UDPUHT32_PGATDRV_ONRY2_10

//%BEGIN UDPUHT32_PGATDRV_ONR_6

`celldefine
module UDPUHT32_PGATDRV_ONR_6 (ENXB);
   input ENXB;

endmodule
`endcelldefine

//%END UDPUHT32_PGATDRV_ONR_6

//%BEGIN UDPUHT32_PGATDRV_ORNRY2_10

`celldefine
module UDPUHT32_PGATDRV_ORNRY2_10 (ENXB);
   input ENXB;

endmodule
`endcelldefine

//%END UDPUHT32_PGATDRV_ORNRY2_10

//%BEGIN UDPUHT32_PGATDRV_ORNR_10

`celldefine
module UDPUHT32_PGATDRV_ORNR_10 (ENXB);
   input ENXB;

endmodule
`endcelldefine

//%END UDPUHT32_PGATDRV_ORNR_10

//%BEGIN UDPUHT32_PGATFILL_CONRY2_10

`celldefine
module UDPUHT32_PGATFILL_CONRY2_10 (ENXB);
   input ENXB;
...
//%END UDPUHT32_PGATFILL_CONRY2_10

//%BEGIN UDPUHT32_PGATFILL_CONR_6

`celldefine
module UDPUHT32_PGATFILL_CONR_6 (ENXB);
   input ENXB;
...
//%END UDPUHT32_PGATFILL_CONR_6

//%BEGIN UDPUHT32_PGATFILL_ONRY2_10

`celldefine
module UDPUHT32_PGATFILL_ONRY2_10 (ENXB);
   input ENXB;
...
//%END UDPUHT32_PGATFILL_ONRY2_10

//%BEGIN UDPUHT32_PGATFILL_ONR_6

`celldefine
module UDPUHT32_PGATFILL_ONR_6 (ENXB);
   input ENXB;
...
//%END UDPUHT32_PGATFILL_ONR_6

//%BEGIN UDPUHT32_TAPPN_DN

`celldefine
module UDPUHT32_TAPPN_DN ();
endmodule
`endcelldefine

//%END UDPUHT32_TAPPN_DN

//%BEGIN UDPUHT32_TAPSS

`celldefine
module UDPUHT32_TAPSS ();
endmodule
`endcelldefine
